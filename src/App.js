...
function App() {
  ...
  useEffect(()=> {
    //Code here runs once when component laods and not again
    //async becauses we send a request to a server, wait, then do something with info
  ...
  const onCountryChange = async(event) => {
    ...
    .then(data => {
      ...
      setCountryInfo(data);
      //Re-centering and zooming doesn't work
